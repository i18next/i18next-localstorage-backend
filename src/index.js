...
class Cache {
     ...
     */
    keyBuilder(language, namespace, { prefix = '' } = {}) {
    ...
    get(language, namespace) {
        ...
        const storageItem = localStorage.getItem(this.keyBuilder(language, namespace, this.options));
    ...
    set(language, namespace, data) {
        storage.setItem(this.keyBuilder(language, namespace, this.options), JSON.stringify(data));
    }
